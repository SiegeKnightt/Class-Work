...
least_common_ancestor(Person1, Person2, Ancestor) :-
    ...
    not((
        ...
        generations(CommonAncestor, Person1, Gen1),
        generations(CommonAncestor, Person2, Gen2),
        generations(Ancestor, Person1, Gen3),
        generations(Ancestor, Person2, Gen4),
        Gen3 < Gen1,
        Gen4 < Gen2
    )).
...
cousin(Cousin, Person) :-
    ...
    parent(UncleAunt, Cousin),
    sibling(Parent, UncleAunt),
    Person \= Cousin.

cousin_type(Person1, Person2, CousinType, Removed) :-
    generations(Ancestor1, Person1, Gen1),
    generations(Ancestor2, Person2, Gen2),
    cousin(Person1, Person2),
    \+ Person1 = Person2,
    least_common_ancestor(Person1, Person2, CommonAncestor),
    generations(CommonAncestor, Person1, RemovedGen1),
    generations(CommonAncestor, Person2, RemovedGen2),
    Removed is max(RemovedGen1, RemovedGen2) - 1,
    (
        Removed = 0 ->
        CousinType = 'sibling'
    ;
