 ...
 *
 * modified from the source file provided at the Anderson and Dahlin website
 *
 * Compile with
 ...
 *    > gcc -pthread bzero.o thread.o -o bzero
 * Run with
 *    > ./bzero
 */
#include <stdio.h>
...
void * go (void *vp) {
    struct bzeroparams *p = (struct bzeroparams *) vp;
